...
public static class PlayerData
{
    ...
    public static int HighLevelRound;
    ...
    private const string KeyLevelRound                  = "PlayerLevelRound";
    private const string KeyHighLevelRound              = "PlayerHighLevelRound";
    ...
    public static void SaveLevelRound ()
    {
        SavePref (KeyLevelRound, LevelRound);
    }

    public static void SaveHighLevelRound ()
    {
        if (HighLevelRound > LevelRound)
            return;

        HighLevelRound = LevelRound;

        SavePref (KeyHighLevelRound, HighLevelRound);
    }
