...
public static class GameConfig
{
    ...
    // =============================== Time for more cash ================================ //
    public const int TimeMoreCash = 900;
    ...
    public const float PercentCoinEarnFromHitItem = 0.1f;
    ...
    public const int MaxEnemyIncreased = 100;
    public const int MaxEnemyOnScreen  = 10;

    // =============================== The label of version ================================ //
    public static string VersionLabel = "v{0} Galaxy Attack © Black Bird 2019";

    // =============================== Save the total item in the store ================================ //
    public const int TotalItem = 30;

    // =============================== When what speed up the fire rate will increase ================================ //
    public const float PercentDecreaseOfSpeedUp = 0.25f;
}