...
public static class Contains
{
    ...
    public static float MultiRewardFromLuckyWheel = 0;
    public static float SpeedUpTimes              = 0;

    public static float EquipmentPercentIncreaseDamage;
    public static float EquipmentPercentIncreaseCritRate;
    public static float EquipmentPercentIncreaseCritAmount;
}
...
public static class Vector
{
    ...
    public static Vector3 Vector3Up         = new Vector3 (0, 1, 0);
...
public static class Durations
{
    ...
    public const float DurationTimeScale   = 0.1f;
