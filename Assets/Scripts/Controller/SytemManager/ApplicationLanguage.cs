...
public class ApplicationLanguage : Singleton<ApplicationLanguage>
{
    ...
    [Header ("Tips")] [SerializeField] private int size_tips_game;
    ...
    public static                   string Text_description_damage_each_hit;
    ...
    public static string Text_description_new_wave,
                         Text_description_wave_lost,
                         Text_description_wave_failed;

    public static string Text_description_update_ios, Text_description_update_android;

    public static string Text_description_equip_crit_amount, Text_description_equip_crit_rate, Text_description_equip_increase_damage;
    ...
    public static string[] Text_tips_game;
    ...
    private void LoadLanguage ()
    {
        ...
        Text_description_damage_each_hit  = share_instance.GetTextValue ("Text_description_damage_each_hit");
        ...
        Text_description_equip_crit_amount     = share_instance.GetTextValue ("Text_description_equip_crit_amount");
        Text_description_equip_crit_rate       = share_instance.GetTextValue ("Text_description_equip_crit_rate");
        Text_description_equip_increase_damage = share_instance.GetTextValue ("Text_description_equip_increase_damage");
        ...
        Text_description_new_wave    = share_instance.GetTextValue ("Text_description_new_wave");
        Text_description_wave_lost   = share_instance.GetTextValue ("Text_description_wave_lost");
        Text_description_wave_failed = share_instance.GetTextValue ("Text_description_wave_failed");
        ...
        Text_tips_game = new string[size_tips_game];

        for (int i = 1; i <= size_tips_game; i++)
        {
            Text_tips_game[i - 1] = share_instance.GetTextValue (string.Format ("Text_tips_game_{0}", i));
        }
    ...
    public static string GetRandomTipsGame ()
    {
        return Text_tips_game.Length > 0 ? Text_tips_game[Random.Range (0, Text_tips_game.Length)] : string.Empty;
    }
