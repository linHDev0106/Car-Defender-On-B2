...
public class GameActionManager : Singleton<GameActionManager>
{
    ...
    public void InstanceBullets (int level, int level_weapon, Vector3 position_start, string tag_enemy, Vector3 angle)
    {
        ...
        script.Init (position_start, angle, tag_enemy, level_weapon);
