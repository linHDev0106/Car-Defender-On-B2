...
public class ApplicationManager : Singleton<ApplicationManager>
{
    ...
    {
    //Remove when you use store links
        Application.OpenURL ("");
        return;
    
        #if UNITY_ANDROID
        Application.OpenURL ("market://details?id=com.oman.mergecarsdefense");
        #elif UNITY_IOS
         Application.OpenURL("itms-apps://itunes.apple.com/app/id[YourID]");
        #endif
    }
