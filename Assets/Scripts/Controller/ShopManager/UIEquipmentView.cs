...
public class UIEquipmentView : MonoBehaviour
{
    ...
    private float profit_upgrade_value;
    ...
    public void RefreshUpgrade ()
    {
        ...
        profit_upgrade      = profit_upgrade_value * level_upgrade;
    ...
    public void RefreshLanguage ()
    {
        switch (equipment_id)
        {
            ...
            case EquipmentEnums.AbilityId.DiscountUpgradeItems:
                ...
                break;
            case EquipmentEnums.AbilityId.IncreaseCritAmount:
                description_equipment.text = string.Format (ApplicationLanguage.Text_description_equip_crit_amount, ApplicationManager.Instance.AppendFromUnit (profit_upgrade, profit_upgrade_unit, 2));
                break;
            case EquipmentEnums.AbilityId.IncreaseCritRate:
                description_equipment.text = string.Format (ApplicationLanguage.Text_description_equip_crit_rate, ApplicationManager.Instance.AppendFromUnit (profit_upgrade, profit_upgrade_unit, 2));
                break;
            case EquipmentEnums.AbilityId.IncreaseDamage:
                description_equipment.text = string.Format (ApplicationLanguage.Text_description_equip_increase_damage, ApplicationManager.Instance.AppendFromUnit (profit_upgrade, profit_upgrade_unit, 2));
                break;
        }
    }
