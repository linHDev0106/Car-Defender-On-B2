...
public class BonusManager : Singleton<BonusManager>, IDialog
{
    ...
    private void UpdateReward ()
    {
        ...
        switch (_BonusCurrencyId)
        {
            ...
            case BonusEnums.BonusId.FreeDiamonds:
                ...
                label_value_get.text = ApplicationManager.Instance.AppendFromUnit (profit, profit_unit);
    ...
    public void InteractWatchAdsForReward ()
    {
        ...
        if (this.IsRewardVideoAvailable ())
        {
            ...
            {
                Instance.OnWatchAdsCompleted (Instance._BonusCurrencyId, Instance._CurrencyData.GetQuantity (Instance._BonusCurrencyId));
