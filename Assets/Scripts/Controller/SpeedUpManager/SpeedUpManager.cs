...
public class SpeedUpManager : Singleton<SpeedUpManager>, IDialog
{
    ...
    private void InitTime ()
    {
        ...
        if (_CurrentTime > 0)
        {
            Contains.SpeedUpTimes = GameConfig.PercentDecreaseOfSpeedUp;
    ...
    public void BuySpeedUpDiamonds ()
    {
        ...
        if (!ApplicationManager.Instance.IsMinusCurrency (GameConfig._DiamondBuySpeedUp, 0, CurrencyEnums.CurrencyId.Diamonds))
        {
